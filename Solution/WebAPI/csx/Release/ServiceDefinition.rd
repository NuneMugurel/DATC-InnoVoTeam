...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="WebAPI" generation="1" functional="0" release="0" Id="de93d868-8622-486d-ba58-def92fed502e" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
  ...
  <implements>
    <implementation Id="e4a1db03-0f13-4983-bf53-c8f3dcd6b8e1" ref="Microsoft.RedDog.Contract\ServiceContract\WebAPIContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="f811ccd9-1e33-46fe-acad-8071e601f6d2" ref="Microsoft.RedDog.Contract\Interface\WebRole:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/WebAPI/WebAPIGroup/WebRole:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="b7b3e364-547a-4a2e-9648-5ffb3dd9545f" ref="Microsoft.RedDog.Contract\Interface\WebRole:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/WebAPI/WebAPIGroup/WebRole:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
