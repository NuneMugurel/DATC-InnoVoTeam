...
namespace WebRole1.Controllers.api
{
    public class VotesController : ApiController
    {
        ...
        {
            return db.Votes.Include(v => v.Candidate).Include(v => v.Voter).Include(v => v.VotingSession);
        }
        ...
        {
            Vote vote = db.Votes.Include(v => v.Candidate).Include(v => v.Voter).Include(v => v.VotingSession).Where(v => v.Id == id).SingleOrDefault();
            if (vote == null)
            {
                return NotFound();
            }
